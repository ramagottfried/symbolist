...
namespace agg
{
                          ...
                          double x3, double y3)
    {
        ...
        m_num_steps = (int)lround(len * 0.25 * m_scale);
                                      ...
                                      unsigned level)
    {
        ...
        if(d > curve_collinearity_epsilon)
        {
            ...
            if(d * d <= m_distance_tolerance_square * (dx*dx + dy*dy))
            {
                ...
                {
                    m_points.emplace_back(point_d(x123, y123));
                    return;
                }
        ...
        else
        {
            ...
            {
                m_points.emplace_back(point_d(x2, y2));
                return;
            }
        }
    ...
    void curve3_div::bezier(double x1, double y1,
                            ...
                            double x3, double y3)
    {
        m_points.emplace_back(point_d(x1, y1));
        recursive_bezier(x1, y1, x2, y2, x3, y3, 0);
        m_points.emplace_back(point_d(x3, y3));
    }
               ...
               int(d3 > curve_collinearity_epsilon))
        {
            ...
            case 1:
                ...
                if(d3 * d3 <= m_distance_tolerance_square * (dx*dx + dy*dy))
                {
                    if(m_angle_tolerance < curve_angle_tolerance_epsilon)
                    {
                        m_points.emplace_back(point_d(x23, y23));
                        return;
                    }
                            ...
                            double x4, double y4)
    {
        ...
        m_points.emplace_back(point_d(x4, y4));
    }
